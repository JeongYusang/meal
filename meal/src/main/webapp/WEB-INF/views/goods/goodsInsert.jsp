...
<input type="hidden" name="s_id" value= "${sellerInfo.s_id}"/>
	<table class="goodsform">
		<tr class="box">
			<th>상품사진*</th>
			<td><input type="file" name="ig_id_main" required="required" /></td>
			
		</tr>
		<tr class="box">
			<th>상품명*</th>
			<td><input type="text" name="g_name" id="g_id" placeholder="상품명"
				required="required" />
				</td>
		</tr>
			<tr class="box">
			<th>상품가격*</th>
			<td><input type="text" name="g_price" id="g_id" placeholder="00000원"
				required="required" />
				</td>
		</tr>
			<tr class="box">
			<th>수량*</th>
			<td><input type="text" name="g_amount" id="g_id" placeholder="재고 수량을 입력해주세요"
				required="required" />
				</td>
		</tr>
		<tr class="box">
			...
			<td>
			<div id = "form-div">
					<input type="radio" id="formradio" name="cate2" checked>
					 <label for="cate2">찌개/탕/찜</label> 
					 <input type="radio" id="formradio" name="cate2" checked>
					 <label for="cate2">식사/안주</label> 
					 <input type="radio" id="formradio" name="cate2" checked> 
					 <label for="cate2">죽</label>
				</div>
					<div id = "form-div">
					<input type="radio" id="formradio" name="cate2" checked>
					 <label for="cate2">간편식</label> 
					 <input type="radio" id="formradio" name="cate2" checked>
					 <label for="cate2">고기</label> 
					 <input type="radio" id="formradio" name="cate2" checked> 
					 <label for="cate2">기타</label>
				</div>
				</td>
		</tr>
		<tr class="box">
		...
		<tr class="box">
			<th>모범음식점 여부*</th>
			<td><div id = "form-div">
					<input type="radio" id="formradio" name="cate3" checked>
		...
		<tr class="box">
			<th>조리 시간*</th>
			<td><input type="text" name="u_id" id="g_time" placeholder="조리시간(분)"
		...
		<tr class="box">
			<th>상세이미지*</th>
			<td><input type="file" name="" required="required" /></td>
		</tr>
		<tr class="box">
			<th>상세설명*</th>
...
<center>
	<input type="submit" id=""  value="상품등록">
	</center>
	</form>
	</div>
</html>